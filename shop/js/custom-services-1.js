(function($) { "use strict";
	...
	jQuery(document).ready(function($){
		...
		var e=new google.maps.LatLng(51.129442,4.577113),
			o={zoom:14,center:new google.maps.LatLng(51.129442,4.577113),
			...
			var g='<div class="map-tooltip"><h6>DE PRASIOLIET</h6><p></p></div>',a=new google.maps.InfoWindow({content:g})
			...
			i=new google.maps.LatLng(51.129442,4.577113),
